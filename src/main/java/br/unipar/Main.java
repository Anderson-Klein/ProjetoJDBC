...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        alterarUsuario("123","cleito", "2000-01-20", "taffe");

        listarTodosUsuario();

        deletarUsuario("taffe");
    ...
    public static void alterarUsuario(String newPassword, String newNome, String newDataNascimento, String username) {
        try {
            ...
            // Prepara a execução de um SQL para atualizar os dados do usuário.
            PreparedStatement preparedStatement = conn.prepareStatement(
                    "UPDATE usuarios SET password = ?, nome = ?, nascimento = ? WHERE username = ?");
    ...
    public static void deletarUsuario(String username) {
        try {
            ...
            // Prepara a execução de um SQL para deletar o usuário.
            PreparedStatement preparedStatement = conn.prepareStatement(
    ...
    public static void deletarTodosUsuarios() {
        try {
            ...
            // Prepara a execução de um SQL para deletar os usuários.
            PreparedStatement preparedStatement = conn.prepareStatement(
    ...
    public static void listarTodosUsuario(){
        try {
            ...
            // Prepara a execução de um SQL para listar os usuários.
